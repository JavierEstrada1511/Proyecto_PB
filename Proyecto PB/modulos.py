...
def grafica_gen(y):
    ...
    plt.title("Distribución de Pokémon por generacion")
...
def grafica_stats(y):
    ...
    plt.title("Estadisticas del Pokémon")
...
def grafica_tipos (y):
    ...
    plt.title("Distribución de Pokemon por tipos de la generacion")
    plt.show()
    


print("Bienvenido a la Api de Pokemon.")
fo = open("consulta\Busquedas.txt","a")
    ...
    while True:
        try:
            ...
            if busq == 1:
                ...
                print("El pokemon", pokemonN, "es de tipo", pokemon_type, ", pesa", PokemonW/10, "Kg y mide", pokemonH/10, "metros. Sus estadisticas son", pokemon_n_stat)
                Mensaje = "El pokemon", pokemonN, "es de tipo", pokemon_type, ", pesa", PokemonW/10, "Kg y mide", pokemonH/10, "metros. Sus estadisticas son", pokemon_n_stat
                ...
                for s in range(1,10,1):
                    ...
                    grafica_tipos(tipos_generacion)
